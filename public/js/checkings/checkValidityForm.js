...
export function checkBreeds() {
  document.querySelector('#createModal form').addEventListener('submit', (event) => {
...
export function createAccountCheck() {
  ...
  nameInput.addEventListener('input', () => checkValidityAndDisplayIndicator(nameInput, nameIndicator));
  colorInput.addEventListener('input', () => checkValidityAndDisplayIndicator(colorInput, colorIndicator));
  selectedColorInput.addEventListener('input', () => checkValidityAndDisplayIndicator(selectedColorInput, colorIndicator));
  serverSelect.addEventListener('input', () => checkValidityAndDisplayIndicator(serverSelect, serverIndicator));
}
